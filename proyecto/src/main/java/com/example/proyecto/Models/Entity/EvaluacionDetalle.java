...
@Entity
@Table(name = "evaluacion_detalle", indexes = {
    @Index(name = "idx_eval_detalle_evaluacion", columnList = "id_evaluacion"),
    @Index(name = "idx_eval_detalle_criterio", columnList = "id_rubrica_criterio")
})
@Setter @Getter
@NoArgsConstructor
@AllArgsConstructor
